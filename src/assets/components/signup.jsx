        ...
        <>
            ...
            <div className='m-auto flex flex-col items-center'>
                ...
                <form action="/signup" method='POST' className='flex flex-col gap-4'>
                    ...
                    <input type="text" id='confirmPassword' name='confirmPassword' placeholder='Confirm password' required="true" className='p-2 rounded border-solid border-2 border-indigo-600'/>
